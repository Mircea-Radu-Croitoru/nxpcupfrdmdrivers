...
- {id: CLK_144M_clock.outFreq, value: 144 MHz}
- {id: CLK_48M_clock.outFreq, value: 48 MHz}
- {id: FLEXCOMM4_clock.outFreq, value: 75 MHz}
...
- {id: SYSCON.FCCLKSEL4.sel, value: SYSCON.PLL_DIV_CLK}
- {id: SYSCON.FLEXCOMM4CLKDIV.scale, value: '2'}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_AttachClk(kPLL_DIV_to_FLEXCOMM4);                 /*!< Switch FLEXCOMM4 to PLL_DIV */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom4Clk, 2U);           /*!< Set FLEXCOMM4CLKDIV divider to value 2 */
